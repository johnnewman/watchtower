...
To flash the microcontroller with the [`controller.ino`](../../microcontroller/arduino/controller.ino) program, you'll need to compile it with the Arduino IDE on any computer. Enable verbose logging in Arduino and attempt to upload the program. You will see a command similar to the following in the console:
```
